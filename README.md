...
**Project**: credit-insight-guru 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: create a dashboard for me that takes as input a firestore keyfile json from the user and queries firestore for all /users/uid and gets the field daily_credits and aggregates that with some stats to give insight into how users use their credits 
...
```sh
git clone https://github.com/GPT-Engineer-App/credit-insight-guru.git
cd credit-insight-guru
npm i
